...
#### Team Name: `9ball`  
<img height="10%" width="15%" alt="9ball mascot" src="9ball_mascot.jpeg"> 

#### Title: `San Diego County Air Pollution Analysis`
  
#### Your team's hackathon idea in One sentence:
##### `Leveraging air quality data to discover locations in San Diego County with levels of air pollution that could be harmful to sensitive populations.`



#### A visual
<img height="10%" width="50%" alt="demo pic" src="website_demo_pic.png"> 
